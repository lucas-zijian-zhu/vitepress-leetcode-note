# [36. Valid Sudoku](https://leetcode.com/problems/valid-sudoku/description/?envType=study-plan-v2&envId=top-interview-150) <Badge type="warning" text="Medium" />
    ...
    func isValidSudoku(_ board: [[Character]]) -> Bool {
        ...
        for i in 0..<9 {
            for j in 0..<9 {
                ...
                let boxKey = "\(num) in box \(i/3)-\(j/3)"
                if !seen.insert(rowKey).inserted || !seen.insert(colKey).inserted || !seen.insert(boxKey).inserted {
                    return false
                }
            }
        }
