# [202. Happy Number](https://leetcode.com/problems/happy-number/description/?envType=study-plan-v2&envId=top-interview-150) <Badge type="info" text="Easy" />
...
class Solution {
    func isHappy(_ n: Int) -> Bool {
        ...
        func digitSquareSum(_ num: Int) -> Int {
            var total = 0
            var value = num
            while value > 0 {
                let digit = value % 10
