# [224. Basic Calculator](https://leetcode.com/problems/basic-calculator/description/?envType=study-plan-v2&envId=top-interview-150) <Badge type="danger" text="Hard" />
        ...
        while i < chars.count {
            ...
            if c.isNumber {
                ...
                while i < chars.count && chars[i].isNumber {
                    number = number * 10 + Int(String(chars[i]))!
                    i += 1
                }
                result += sign * number
                continue
